 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.sample.components.xfpage;
...
_global_clientlib = renderContext.call("use", "/libs/granite/sightly/templates/clientlib.html", obj());
{
    ...
    {
        String var_templateoptions1_field$_categories = "sample.dependencies";
        {
...
_global_clientlib = renderContext.call("use", "/libs/granite/sightly/templates/clientlib.html", obj());
{
    ...
    {
        String var_templateoptions3_field$_categories = "sample.base";
        {
